...
export const AgencyHeader: React.FC<AgencyHeaderProps> = ({ name, city, postalCode, status }) => {
    return (
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm mb-6">
            ...
            <Button className="bg-primary hover:bg-blue-700 text-white shadow-md shadow-blue-500/20">
