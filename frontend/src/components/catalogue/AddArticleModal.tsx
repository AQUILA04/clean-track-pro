...
export const AddArticleModal: React.FC<AddArticleModalProps> = ({ isOpen, onClose, onSubmit, initialData }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-[600px] p-6 relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-sm font-semibold text-gray-800 mb-2">Nom de l'article</label>
                        <Input
                            value={name}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <select
                                className="w-full appearance-none rounded-lg border border-gray-200 py-3 px-4 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white"
                                value={category}
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-800 mb-2">Sélecteur d'icône</label>
